...
export default function GovernancePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      {/* Navigation Header */}
      <nav className="sticky top-0 z-50 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm border-b border-gray-100 dark:border-gray-700 transition-colors duration-300">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <a href="/" className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-base sm:text-xl font-bold text-slate-900 dark:text-white transition-colors duration-300">
                    Fondation Marie Mwape
                  </div>
                  <div className="text-xs sm:text-sm text-slate-600 dark:text-gray-300 transition-colors duration-300">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="p-2 text-slate-700 dark:text-gray-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-gray-700 rounded-lg transition-colors duration-300"
